    ...
    <ActionSection>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Si es necesario, puedes cerrar todas tus demás sesiones de navegador en todos tus dispositivos. Algunas de tus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.
            </div>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, ingresa tu contraseña para confirmar que deseas cerrar tus sesiones en otros navegadores en todos tus dispositivos.
