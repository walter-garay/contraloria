        ...
        <Form layout="vertical" @finish="enviarFormulario" :model="denuncia">
            ...
            >
                <Input
                    ...
                    placeholder="Ingrese la entidad relacionada con la denuncia"
                    autofocus
                />
            </FormItem>
            ...
            >
                <Input
                    v-model:value="denuncia.lugar"
                    placeholder="Ingrese el lugar de la denuncia"
                />
            </FormItem>
            ...
            <FormItem
                ...
                name="fecha_probable"
                :rules="[{ required: true, message: 'Por favor ingrese la fecha probable' }]"
            >
                <DatePicker
                    v-model:value="denuncia.fecha_probable"
                    placeholder="Seleccione la fecha probable"
                    style="width: 100%"
                />
            </FormItem>
            ...
            <FormItem label="Prioridad" name="prioridad">
                <InputNumber
                    ...
                    min="1"
                    max="5"
                    placeholder="Seleccione la prioridad (1 a 5)"
                    style="width: 100%"
                />
            </FormItem>
            ...
            <FormItem
                label="Tipo de Hecho"
                name="tipo_de_hecho"
                :rules="[{ required: true, message: 'Por favor seleccione un tipo de hecho' }]"
            >
                <Select
                    v-model:value="denuncia.tipo_de_hecho"
                    placeholder="Seleccione un tipo de hecho"
                >
                    <Select.Option
                        v-for="opcion in opcionesTipoHecho"
                        :key="opcion"
                        :value="opcion"
                    >
                        {{ opcion }}
            ...
            <FormItem label="Monto Económico" name="monto_economico">
                <InputNumber
                    v-model:value="denuncia.monto_economico"
                    min="0"
                    step="0.01"
            ...
            <FormItem
                ...
                name="otros_colaboradores"
            >
                <Input.TextArea
                    v-model:value="denuncia.otros_colaboradores"
                    placeholder="Ingrese otros colaboradores si los hay"
                    rows="2"
                />
            </FormItem>
            ...
            <FormItem
                label="Estado"
                name="estado"
                :rules="[{ required: true, message: 'Por favor seleccione el estado de la denuncia' }]"
            >
                <Select
                    v-model:value="denuncia.estado"
                    placeholder="Seleccione el estado de la denuncia"
                >
...
import {
    ...
    Select,
    message,
} from 'ant-design-vue'; // Eliminado 'Option'
